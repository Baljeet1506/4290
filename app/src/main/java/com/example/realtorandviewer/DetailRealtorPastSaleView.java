...
public class DetailRealtorPastSaleView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("PastSales").child(Login.uID_);
        ...
        reference.child(Login.MY_PAST_SALE_POSITION).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(DetailRealtorPastSaleView.this, "The User info did not load", Toast.LENGTH_SHORT).show();
            }
        });
